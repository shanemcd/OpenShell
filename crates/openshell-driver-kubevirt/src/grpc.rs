...
use crate::KubevirtComputeDriver;

#[derive(Debug, Clone)]
pub struct ComputeDriverService {
    driver: KubevirtComputeDriver,
}

impl ComputeDriverService {
    #[must_use]
    pub fn new(driver: KubevirtComputeDriver) -> Self {
        Self { driver }
    }
}
...
impl ComputeDriver for ComputeDriverService {
    ...
    async fn validate_sandbox_create(
        ...
        let _sandbox = request
            .into_inner()
            .sandbox
            .ok_or_else(|| Status::invalid_argument("sandbox is required"))?;
        // Basic validation — image must be non-empty
